...
!*                                                                       *
!*                                                                       *
!*     by Napsu Karmitsa 2004 (last modified 14.05.2024)                 *
!*                                                                       *
!*                                                                       *
...
CONTAINS
    ...
    SUBROUTINE optim2(x0,x1,fvalue,nc,nft)
        ...
        REAL(KIND=prec) ::  &
            ...
            x1(nc*nft),     &
            fvalue
        INTEGER, INTENT(IN) :: nc,nft   
!f2py   depend(nc*nft) x0
!f2py   depend(nc*nft) x1
