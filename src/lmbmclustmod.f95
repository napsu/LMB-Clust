...
!*     (version 3.0, last modified 14.05.2024).                          *
!*                                                                       *
...
CONTAINS
    ...
    SUBROUTINE check(x,db,db2,dn,dn3,sep,maxdim,nclust)
        ...
        INTEGER, INTENT(IN):: maxdim,nclust
        REAL(KIND=prec) ::      &
    ...
    !=========================================================================
    SUBROUTINE step2(toler,nstart,x2,maxsize)
