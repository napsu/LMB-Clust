...
!*     sum of squares clustering problem (version 3.0, last modified     *
!*     14.05.2024).                                                      *
!*                                                                       *
...
CONTAINS
    ...
    !=============================================
    SUBROUTINE auxfunc(x,fval,maxdim)
    ...
    !=============================================
    SUBROUTINE clusterfunc(x,f,maxdim)
    ...
    !==============================================================
    SUBROUTINE fgrad(x,grad,maxdim)
